...
\cmdentry{dpyt}{dpyt 00:55:05}{Set the timer to a specific time in the hh:mm:ss format, but not start the timer.\\
\indent (Example above displays a timer for 55 minutes and 5 seconds)}
